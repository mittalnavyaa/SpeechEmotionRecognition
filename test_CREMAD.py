...
def main():
    ...
    embeddings_path = 'C:/Users/navya/wav2vec2-lg-xlsr-en-speech-emotion-recognition/embeddings_CREMAD.npy'
    labels_path = 'C:/Users/navya/wav2vec2-lg-xlsr-en-speech-emotion-recognition/labels_CREMAD.npy'
    ...
    for fold, (train_idx, val_idx) in enumerate(kfold.split(X_train, y_train)):
        ...
        hidden_dim = 1024
        output_dim = 6  # Updated output dimension for CREMA-D dataset
    ...
    emotion_labels = ['SAD', 'ANG', 'DIS', 'FEA', 'HAP', 'NEU']
    ...
    plt.savefig('confusion_matrix_CREMAD.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig('avg_train_vs_val_accuracy_CREMAD.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig('avg_train_vs_test_accuracy_CREMAD.png')
    plt.close()
